public class Main {
    public static void main(String[] args) {
        ...
        Reservation reservation1= new Reservation(client1,session2,3);
        Reservation reservation2= new Reservation(client2,session2,2);
        Reservation reservation3= new Reservation(client3,session2,3);

        reservation1.createReservation(reservation1);
        reservation2.createReservation(reservation2);
        reservation3.createReservation(reservation3);
